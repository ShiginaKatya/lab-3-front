<template>
    <div class="font-sans mx-auto my-4 pb-4 w-3/4">
        <div class="flex justify-start gap-4 border-b-blue border-b p-2">
                ...
                <router-link to="/control" class=" text-sm text-black font-bold py-6" >Контроль качества</router-link>
                
        </div>
        <div class="flex justify-between gap-2  w-10/12 my-4 mx-auto">
            <router-link to="/addcontrol" class="block  text-s"><el-button  class="border-orange" type='primary' style="width: 200px" >Добавить</el-button></router-link>
        </div>
        <table class=" h-96 mx-auto w-10/12 border my-4 border-gray-600 ">
                <thead> <!-- Заголовок таблицы -->
                <tr class="text-xs"> 
                    <th class=" border  border-gray-500 p-2 w-3/12">Параметр качества</th>
                    <th class="border-collapse border  border-gray-500 p-2 w-3/12">Оценка</th>
                </tr>
                </thead>
            ...
            <div class="flex justify-start gap-5 p-12 mx-auto " >
                  <el-button  class="border-orange" style="width: 200px" >Изменить оценку</el-button>
