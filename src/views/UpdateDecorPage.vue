    ...
    <div class="font-sans mx-auto my-8 pb-4 w-2/4">
        ...
        <van-cell-group inset class="">
            ...
            <div class="text-sm flex justify-between gap-8 m-4 border-b">
                <p>Наименование</p>
                <input type="text" v-model="name" class="w-10/12 h-8 " >
            </div>
             <van-field style=""
            v-model="count"
            name="count"
            ...
            <div class="text-sm flex justify-between gap-8 m-4 border-b">
                    <p>Поставщик</p>
                    <select class="w-10/12 h-8 " v-model="selected_provider">
        ...
        <div class="flex justify-center gap-5 m-6" >
            <router-link to='/decor'><el-button @click="submit" style="width: 200px" >Сохранить</el-button></router-link>
            <router-link to='/decor'><el-button style="width: 200px;background-color:#F56C6C" type="danger" >Отменить</el-button></router-link>
        </div>
